...
export default function Form(){
    return(
        <div className='bg-white px-10 py-20 rounded-3xl border-2 bordergray-100'>
            ...
            <div className='mt-8'>
                <div><label className='tex-lg font-medium'>Email</label>
                    <input
            ...
            <div className='mt-8'>
                <div><label className='tex-lg font-medium'>Pasword</label>
                    <input
                        className='w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent'
            ...
            <div className='mt-8 flex justify-between items-center'>
                <div>
                    ...
                    id='remenber'
                    />
                    <label className='ml-2 font-medium text-base' for="remenber">Remenber for 30 days</label>
                </div>
            ...
            <div className='mt-8 flex flex-col gap-y-4'>
                 <button className=' active:scale-[0.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out py-3 rounded-xl bg-violet-500 text-white text-lg font-bold'>Sing in</button>
